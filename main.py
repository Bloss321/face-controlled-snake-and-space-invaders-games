...
if __name__ == '__main__':
    ...
    def load_correct_game_buttons(current_game: str):
        buttons = {
            "snake keyboard": snake_keyboard_button,
            "snake face": snake_face_button,
            "space invaders keyboard": space_invaders_keyboard_button,
            "space invaders face": space_invaders_face_button,
        }
    ...
    def resize_video_output(frame, resize_scale):  # scale given as decimal e.g. 0.75
